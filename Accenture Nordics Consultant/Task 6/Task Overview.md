...
- [Task Overview.md](..\Task 4\Task Overview.md) <!-- score: 2.612 | shared: client, complete, email, has, his -->
- [Task Overview.md](..\Task 1\Task Overview.md) <!-- score: 2.462 | shared: client, director, happy, has, help -->
- [Client Note.md](..\Task 1\Client Note.md) <!-- score: 2.271 | shared: call, client, don, get, going -->
- [Task Expectations.md](..\Task 1\Task Expectations.md) <!-- score: 2.245 | shared: already, best, director, email, get -->
- [Task Overview.md](..\Task 7\Task Overview.md) <!-- score: 2.226 | shared: choose, client, error, happy, help -->
