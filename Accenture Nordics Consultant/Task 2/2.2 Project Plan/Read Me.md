...
- [Sample.md](..\Sample.md) <!-- score: 3.768 | shared: adjust, agree, analyze, app, best -->
- [Prioritization.md](..\Prioritization.md) <!-- score: 3.723 | shared: adjust, agree, analyze, app, best -->
- [Example Answer.md](Example Answer.md) <!-- score: 3.608 | shared: adjust, agree, analyze, best, change -->
- [Prioritization.md](..\Context\Prioritization.md) <!-- score: 3.601 | shared: adjust, agree, analyze, app, best -->
- [Example.md](..\Context\Example.md) <!-- score: 2.332 | shared: app, changes, final, gather, implement -->
