...
- [Choose 3 Priorities.md](..\Choose 3 Priorities.md) <!-- score: 3.303 | shared: app, best, changes, create, develop -->
- [Prioritization.md](..\..\Task 2\Prioritization.md) <!-- score: 3.070 | shared: activity, app, best, changes, create -->
- [Task Overview.md](..\Task Overview.md) <!-- score: 2.395 | shared: app, called, digital, eva, focus -->
- [Example Answer.md](..\..\Task 2\2.2 Project Plan\Example Answer.md) <!-- score: 2.392 | shared: activity, answer, best, changes, create -->
- [Client Note.md](..\Client Note.md) <!-- score: 2.340 | shared: awful, current, digital, don, done -->
